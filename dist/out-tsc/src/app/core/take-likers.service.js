...
let TakeLikesService = class TakeLikesService {
...
TakeLikesService = __decorate([
    Injectable({
        providedIn: 'root'
    })
], TakeLikesService);
export { TakeLikesService };
//# sourceMappingURL=take-likers.service.js.map