                    ...
                    g.events.$on(i, "dragover dragenter", ".fr-image-upload-layer", function() {
                        ...
                        if (this.files) {
                            ...
                            loadImage(
                                ...
                                (img) => {
                                    if (img.type === "error") {
                                        alert('Error loading image, please try again with another image')
                                    } else {
                    
                                        console.log('load image in-post')
                                        img.toBlob((blob) => {
                                            
                                            var newFiles = [blob]
                                            e.events.disableBlur(), i.find("input:focus").blur(), e.events.enableBlur(), e.image.upload(newFiles, d)
