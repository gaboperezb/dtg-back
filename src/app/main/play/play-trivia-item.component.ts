...
@Component({
    selector: 'play-trivia-item',
    templateUrl: './play-trivia-item.component.html',
    styleUrls: ['./play-trivia-item.component.scss'],
})
export class PlayTriviaItemComponent {
    ...
    goToTrivia() {
        ...
        if (this.authService.isLoggedIn()) {
            this.router.navigate(['/trivia', this.trivia._id]);
        } else {
