...
module.exports = function(agenda) {
    ...
    agenda.define('update take ranking', (job, done) => {

            Take.find({date: {$gte: new Date(Date.now() - 2.419e+9)}}, {likers: 1, replies: 1, ranking: 1, rankingTop: 1, date:1, take: 1, user: 1})//36 hrs
                .exec((err, takes) => {
