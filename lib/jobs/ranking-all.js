...
module.exports = function(agenda) {
    ...
    agenda.define('update ranking all', (job, done) => {
        
            Thread.find({date: {$gte: new Date(Date.now() - 2.419e+9)}}, {likers: 1, replies: 1, views:1, ranking: 1, rankingTop: 1, date:1, title:1, user: 1})
                .exec((err, threads) => {
